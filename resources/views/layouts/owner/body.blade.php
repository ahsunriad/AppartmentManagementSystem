...
<!-- jQuery 3 -->
<script src="{{asset('frontend/jquery/dist/jquery.min.js')}}"></script>
<!-- jQuery UI 1.11.4 -->
...
<!-- Morris.js charts -->
<script src="{{asset('frontend/raphael/raphael.min.js')}}"></script>
<script src="{{asset('frontend/morris.js/morris.min.js')}}"></script>
<!-- Sparkline -->
<script src="{{asset('frontend/jquery-sparkline/dist/jquery.sparkline.min.js')}}"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="{{asset('frontend/jquery-knob/dist/jquery.knob.min.js')}}"></script>
<!-- daterangepicker -->
<script src="{{asset('frontend/moment/min/moment.min.js')}}"></script>
<script src="{{asset('frontend/bootstrap-daterangepicker/daterangepicker.js')}}"></script>
<!-- datepicker -->
<script src="{{asset('frontend/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js')}}"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="{{asset('frontend/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js')}}"></script>
<!-- Slimscroll -->
<script src="{{asset('frontend/jquery-slimscroll/jquery.slimscroll.min.js')}}"></script>
<!-- FastClick -->
<script src="{{asset('frontend/fastclick/lib/fastclick.js')}}"></script>
<!-- AdminLTE App -->
